...
import longse.com.herospeed.tools.KeyboardTool;

/**
 * @author by ly on 2017/10/2.
 */
...
public class TitleView extends FrameLayout {
    ...
    private void initView(final Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mTitleSize = a.getDimensionPixelSize(R.styleable.RxTitle_titleSize, ImageTool.dip2px(20, context)
            );//标题字体大小
            ...
            mLeftTextSize = a.getDimensionPixelSize(R.styleable.RxTitle_leftTextSize, ImageTool.dip2px(8, context));//标题字体大小
            ...
            mRightTextSize = a.getDimensionPixelSize(R.styleable.RxTitle_rightTextSize, ImageTool.dip2px(8, context));//标题字体大小
