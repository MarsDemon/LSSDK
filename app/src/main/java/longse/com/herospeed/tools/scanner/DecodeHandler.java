...
final class DecodeHandler extends Handler {
    ...
    DecodeHandler(SearchActivity activity) {
	...
	/*private void decode(byte[] data, int width, int height) {
		...
		if (result != null) {
			if(null != activity.getHandler()){
				...
				msg.obj = "二维码:"+result;
				msg.what = longse.com.herospeed.R.id.decode_succeeded;
			...
			if(result_line != null){
				...
				if (null != activity.getHandler()) {
					activity.getHandler().sendEmptyMessage(longse.com.herospeed.R.id.decode_failed);
				}
			}
    ...
    public void handleMessage(Message message) {
        if (message.what == longse.com.herospeed.R.id.decode) {
            decode((byte[]) message.obj, message.arg1, message.arg2);
        } else if (message.what == longse.com.herospeed.R.id.quit) {
