...
import longse.com.learing.menu.animation.DefaultAnimationHandler;
import longse.com.learing.menu.animation.MenuAnimationHandler;
...
public class FloatingActionMenu {
    ...
    public void open(boolean animated) {
        ...
        ObjectAnimator animator = ObjectAnimator.ofFloat(mainActionView, "rotation", 0, -110, -90);
    ...
    public void close(boolean animated) {
        ...
        ObjectAnimator animator = ObjectAnimator.ofFloat(mainActionView, "rotation", -90, 20, 0);
        animator.setDuration(500);
        animator.start();
