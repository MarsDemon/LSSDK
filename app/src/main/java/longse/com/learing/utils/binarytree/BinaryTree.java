package longse.com.learing.utils.binarytree;
...
public class BinaryTree {
    ...
    private TreeNode parent(TreeNode element) {
    ...
    // 所以应该采用后续遍历，当访问某个节点时候该节点的存储空间释放
    ...
    public void noRecPostOrder(TreeNode p) {
        ...
        while (p != null) {
            ...
            //当前结点无右子树或右子树已经输出
            if (p.rightChild == null || p.rightChild == node) {
                visted(p);
                //纪录上一个已输出结点
                node = p;
                if (stack.empty())
