package longse.com.learing.widget.photozoom;
...
import longse.com.herospeed.MainActivity;
...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayList<String> pictureList = new ArrayList<>(Arrays.asList(images));
        ...
        for (int i = 0; i < cnt; i++) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    PhotoBrowseActivity.startWithElement(TestActivity.this, pictureList, index, imageView);
                }
            });
